...
module.exports = function Server(options) {
  ...
  (function applyRoutes() {
    const controllers = {
      api: new require('./controllers/api')({ redis: options.encryptedRedis }),
      oauth: new require('./controllers/oauth')(),
      repo: new require('./controllers/repo')({ redis: options.encryptedRedis }),
