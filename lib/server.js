...
module.exports = function Server(options) {
  util.enforceArgs(options, ['passport', 'port', 'scanManager', 'sessionSecret', 'sessionStore', 'userStore']);
  const app = express();
  ...
  (function socketIo() {
    ...
    //io.sockets.in('scans:log:a54ac378d3b69b18ec45ae1f7162724c4aabe033d0d37d91').emit('log', 'message');
  })();
