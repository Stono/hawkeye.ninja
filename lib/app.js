...
module.exports = function App(config) {
  ...
  const scanStore = new JsonStore('scans', encryptedRedis);
  const scanList = new List('scans:list', encryptedRedis);
  const scanManager = new ScanManager(scanStore, scanList);
